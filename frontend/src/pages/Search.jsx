  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (error.response.status === 404) {
        toast.error(
          "Não foi encontrado. Verifique se você está procurando na categoria correta."
        );
      } else {
        toast.error(
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <input
            ...
            placeholder={
              activeTab === "movie"
                ? "Qual filme está procurando?"
                : activeTab === "tv"
                ? "Qual série está procurando?"
                : "Qual ator ou atriz está procurando?"
            }
